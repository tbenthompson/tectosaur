...
void derotate_adj_mat(NPArray<float> adj_mat, NPArray<long> obs_clicks, NPArray<long> src_clicks) 
{
    ...
    auto* obs_clicks_ptr = reinterpret_cast<long*>(obs_clicks.request().ptr);
    auto* src_clicks_ptr = reinterpret_cast<long*>(src_clicks.request().ptr);
    auto* adj_mat_ptr = reinterpret_cast<float*>(adj_mat.request().ptr);
        ...
        NPArray<double> in_data, NPArray<long> rows, NPArray<long> cols) 
{
    ...
    auto rows_ptr = reinterpret_cast<long*>(rows.request().ptr);
    auto cols_ptr = reinterpret_cast<long*>(cols.request().ptr);
    auto in_data_ptr = reinterpret_cast<double*>(in_data.request().ptr);
    ...
    auto indptr_ptr = reinterpret_cast<int*>(indptr.request().ptr);
    auto indices_ptr = reinterpret_cast<int*>(indices.request().ptr);
    auto data_ptr = reinterpret_cast<double*>(data.request().ptr);
...
PYBIND11_PLUGIN(helpers) {
    pybind11::module m("helpers", "");

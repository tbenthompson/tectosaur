...
def data_to_gpu(fmm_mat):
    ...
    #TODO: Revert to one shared kernel.
    gd['d2e'] = gd['module'].d2e_kernel
    gd['u2e'] = gd['module'].c2e_kernel
...
def gpu_c2e(fmm_mat, gd, level, evs, d_or_u, out_arr, in_arr):

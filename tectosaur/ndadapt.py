...
import cppimport
adapt_logic = cppimport.imp('tectosaur.adapt_logic').adapt_logic

from tectosaur.quad import gaussxw

####TODO: USE QUADRATURE.py
...
def hadapt(integrand, mins, maxs, tol,
    ...
    initial_est = integrand(np.array([mins]), np.array([maxs]))[0]
    ...
    for i in range(max_refinements):
        ...
        int_start = time.time()
        cell_integrals = integrand(cell_mins, cell_maxs)
